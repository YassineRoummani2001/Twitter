        ...
        <div class='main'>
            ...
            <div class='righter mt-4'>
                <div class='inner-righter'>
                    <div class='acc'>
                        <div class='acc-heading'>
                            <h5>Theme And Languages</h5>
                        </div>
                        <div class='acc-content'>
                        <div class='acc-wrap'>
                        <label class='ml-3 pl-6' for=''>Detect The Theme </label>
                        <select class="form-select form-select-lg mb-3 mr-4 content-right" aria-label="Default select example">
                    ...
                    <div class='acc-wrap'>
                        <label class='ml-3 pl-6' for=''>Detect The Language </label>
                        <select class="form-select form-select-lg mb-3 mr-4 content-right" aria-label="Default select example">
